...
namespace Sanchez.Workflow.Steps.Equirectangular
{
    public class RenderOverlay : StepBody, IRegistrationStepBody
    {
        ...
        public override ExecutionResult Run(IStepExecutionContext context)
        {
            ...
            TargetImage.Mutate(c =>
            {
                c.DrawImage(OverlayImage, PixelColorBlendingMode.Normal, 1.0f);
            });
    ...
    {
        internal static IStepBuilder<EquirectangularWorkflowData, RenderOverlay> RenderOverlay<TStep>(this IStepBuilder<EquirectangularWorkflowData, TStep> builder)
            where TStep : IStepBody
            => builder
                .Then<TStep, RenderOverlay, EquirectangularWorkflowData>("Render overlay")
                .WithRegistration()
