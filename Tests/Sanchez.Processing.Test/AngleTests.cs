...
public class ProjectionAngleTests : AbstractTests
{
    ...
    public void ToX()
    {
        var pixelRange = new AngleRange(Angle.FromDegrees(-180), Angle.FromDegrees(180)).ToPixelRangeX(200);
    ...
    {
        var pixelRange = new AngleRange(Angle.FromDegrees(-3), Angle.FromDegrees(-53)).ToPixelRangeY(200);
    ...
    public void ToY()
    {
        var pixelRange = new AngleRange(Angle.FromDegrees(90), Angle.FromDegrees(-90)).ToPixelRangeY(200);
    ...
    {
        var pixelRange = new AngleRange(Angle.FromDegrees(-34.4506617165), Angle.FromDegrees(-46.641235447)).ToPixelRangeY(5424);
