...
public record GeostationaryOptions : CommandLineOptions
{
    ...
    [Option('h', "haze", HelpText = "Amount of atmosphere to apply to image; valid values are between 0 (no haze) and 1 (full haze)", Required = false, Default = 0.9f)]
    public float AtmosphereAmount { get; set; }
        
    [Option('O', "hazeopacity", HelpText = "Opacity of atmosphere; valid values are between 0 (transparent) and 1 (opaque)", Required = false, Default = 0.6f)]
