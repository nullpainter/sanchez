    ...
    public sealed class RenderOptions
    {
        ...
        public bool MultipleTargets
        {
            get
            {
                ...
                // Equirectangular projection with stitching always composites to a single image
                if (Projection == ProjectionType.Equirectangular) return !EquirectangularRender!.StitchImages;
        ...
        /// <summary>
        ///     Target timestamp in UTC if combining multiple files.
        /// </summary>
        public DateTime? TargetTimestamp { get; set; }

        /// <summary>
        ///     Tolerance from <see cref="TargetTimestamp"/> in identifying suitable satellite images when combining.
        /// </summary>
        public TimeSpan Tolerance { get; set; }

        /// <summary>
        ///     Number of files to process in parallel. This may speed up operations if I/O bound.
        /// </summary>
