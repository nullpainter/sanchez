...
using static Sanchez.Models.Constants.Earth;

namespace Sanchez.Projections
{
    /// <remarks>
    ...
    public static class ReverseGeostationaryProjection
    {
        ...
        /// </summary>
        /// <remarks>
        ///    The <see cref="o:ToGeodetic(double,VerticalScanningCalculations,Sanchez.Models.Configuration.SatelliteDefinition,out double,out double)"/> method with
