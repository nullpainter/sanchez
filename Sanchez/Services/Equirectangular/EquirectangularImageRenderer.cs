...
namespace Sanchez.Services.Equirectangular
{
    ...
    {
        Task<Image<Rgba32>> ComposeAsync(Image<Rgba32> stitched, Activity activity);
    }
    ...
    public class EquirectangularImageRenderer : IEquirectangularImageRenderer
    {
        ...
        public async Task<Image<Rgba32>> ComposeAsync(Image<Rgba32> stitched, Activity activity)
        {
