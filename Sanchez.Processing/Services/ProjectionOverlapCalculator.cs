...
{
    private Dictionary<SatelliteDefinition, AngleRange>? _definitions;
    ...
    public ProjectionRange GetNonOverlappingRange(SatelliteDefinition definition)
    {
        ...
        return new ProjectionRange(new AngleRange(minLongitude, maxLongitude), overlappingLeft, overlappingRight);
    }
}