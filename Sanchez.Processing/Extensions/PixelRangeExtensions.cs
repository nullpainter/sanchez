...
namespace Sanchez.Processing.Extensions
{
    public static class PixelRangeExtensions
    {
        ...
        /// </summary>
        public static PixelRange ToPixelRangeX(this Range range, int width) => new(range, angle => angle.ToX(width));
        ...
        /// </summary>
        public static PixelRange ToPixelRangeY(this Range range, int height) => new(range, angle => angle.ToY(height));
